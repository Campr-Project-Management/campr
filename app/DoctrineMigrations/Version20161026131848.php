 ...
 */
class Version20161026131848 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE work_package_project_work_cost_type CHANGE project_work_cost_type_id project_work_cost_type_id INT DEFAULT NULL, CHANGE work_package_id work_package_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT \'Resource\' NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE work_package_project_work_cost_type CHANGE work_package_id work_package_id INT NOT NULL, CHANGE project_work_cost_type_id project_work_cost_type_id INT NOT NULL, CHANGE name name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
