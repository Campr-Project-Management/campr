            ...
            <div class="page-section">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="hero-text">
                            {{ translate('message.close_down_report') }}
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="vueditor-holder">
                            <div class="vueditor-header">{{ translate('message.overall_impression') }}</div>
                ...
                <div class="row margintop40">
                    ...
                    <div class="col-md-4">
                        <h4>{{ translate('message.reflection') }}: {{ translate('message.performance_schedule')
                            }}</h4>
                        <div class="vueditor-holder">
                            <div class="vueditor campr-editor">
                                <br>
                    ...
                    <div class="col-md-4">
                        <h4>{{ translate('message.reflection') }}: {{ translate('message.organization_context')
                            }}</h4>
                        <div class="vueditor-holder">
                            <div class="vueditor campr-editor">
                                <br>
                    ...
                    <div class="col-md-4">
                        <h4>{{ translate('message.reflection') }}: {{ translate('message.project_management')
                            }}</h4>
                        <div class="vueditor-holder">
                            <div class="vueditor campr-editor">
                                <br>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-wrapper" v-if="closeDownActions">
                            <table class="table table-striped"
                                   v-if="closeDownActions.items && closeDownActions.items.length > 0">
                                <tbody>
                            ...
                            <div v-else>{{ translate('label.no_data') }}</div>
                        </div>
                        <div v-else>{{ translate('label.no_data') }}</div>
                    </div>
                </div>
                ...
                <div class="row margintop40">
                    <div class="col-md-6 col-md-offset-3">
                        <h3 class="text-center">{{ translate('message.project_acceptance') }}</h3>
