...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            url() {
                if (typeof window === 'undefined') {
                    return '//placehold.it/' + this.width + 'x' + this.height;
                }
        ...
        methods: {
            /**
             * During SSR since both window and document are undefined, we can't draw in a canvas.
             * So we create a recursive function that will check during
             */
            createCallback() {
