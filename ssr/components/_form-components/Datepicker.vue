<template>
    <div class="datepicker" :class="wrapperClass">
        ...
        <div class="calendar day-view" v-show="showDayView" v-bind:style="calendarStyle">
            ...
            <span class="cell day-header" v-for="d in daysOfWeek" :key="'daysOfWeek_' + d">{{ d }}</span>
            <span class="cell day blank" v-for="d in blankDays" :key="'blankDays_' + d"></span>
            <span class="cell day"
                   v-for="day in days"
                   :key="'cell_day_' + day.date"
                   track-by="timestamp"
