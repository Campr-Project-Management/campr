...
$(document).ready(function(){
    ...
    /*----------------------------------------------------------
        Dropdown Menu
    -----------------------------------------------------------*/
    if($('.dropdown:not(.bootstrap-select)')[0]) {
	    //Propagate
        $('body').on('click', '.dropdown.open:not(.bootstrap-select) .dropdown-menu', function(e){
            e.stopPropagation();
        });

        $('.dropdown:not(.bootstrap-select)').on('shown.bs.dropdown', function () {
        ...
        $('.dropdown:not(.bootstrap-select)').on('hide.bs.dropdown', function (e) {
            if($(this).attr('data-animation')) {
                e.preventDefault();
                $this = $(this);
    ...
    /*-----------------------------------------------------------
        Color picker used for project add/edit label 
    -----------------------------------------------------------*/
            ...
            $elm
                ...
                .on('change', 'input', function(e) {
                    var value = this.value,
                        ...
                        type = (typeof className.split('-')[1]) ? className.split('-')[1] : '',
                        color = {value: value}
                    ;
