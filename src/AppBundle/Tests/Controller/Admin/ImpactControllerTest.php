...
class ImpactControllerTest extends BaseController
{
    ...
    public function testCreateAction()
    {
        ...
        $this->assertContains('Impact successfully created!', $this->client->getResponse()->getContent());
    ...
    public function testDeleteAction()
    {
        ...
        $crawler = $this->client->request(Request::METHOD_GET, sprintf('/admin/impact/%d/edit', $impact->getId()));
        ...
        $this->client->followRedirect();
        $this->assertContains('Impact successfully deleted!', $this->client->getResponse()->getContent());
    }
    ...
    public function testFormIsDisplayedOnEditPage()
    {
        ...
        /** @var Crawler $crawler */
        $crawler = $this->client->request(Request::METHOD_GET, '/admin/impact/1/edit');
    ...
    public function testEditAction()
    {
        ...
        $crawler = $this->client->request(Request::METHOD_GET, '/admin/impact/2/edit');
        ...
        $this->client->followRedirect();
        $this->assertContains('Impact successfully edited!', $this->client->getResponse()->getContent());
    }
    ...
    public function testDataTableOnListPage()
    {
        ...
        /** @var Crawler $crawler */
        $crawler = $this->client->request(Request::METHOD_GET, '/admin/impact/list');
    ...
    public function testTableStructureOnShowAction()
    {
        ...
        $crawler = $this->client->request(Request::METHOD_GET, '/admin/impact/1/show');
