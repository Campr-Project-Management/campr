...
class ProjectWorkCostTypeControllerTest extends BaseController
{
    ...
    public function testListAction(
        ...
        for ($i = 1; $i <= 2; ++$i) {
            $pm = $this->em->getRepository(ProjectWorkCostType::class)->find($i);
    ...
    public function testCreateAction(
        ...
        $projectWorkCostType = json_decode($response->getContent(), true);
        $responseContent['createdAt'] = $projectWorkCostType['createdAt'];
        $responseContent['updatedAt'] = $projectWorkCostType['updatedAt'];
        ...
        $projectWorkCostType = $this
            ...
            ->find($projectWorkCostType['id'])
        ;
        $this->em->remove($projectWorkCostType);
        $this->em->flush();
    }
    ...
    public function testNameIsUniqueOnCreateAction(
        ...
        $projectWorkCostType = (new ProjectWorkCostType())
            ->setName('project-work-cost-type3')
            ->setSequence(1)
        ;
    ...
    public function getDataForSequenceIsNumberOnCreateAction()
    {
        return [
            [
                [
                    'name' => 'project-work-cost-type3',
                    'sequence' => 'project-work-cost-type',
                ],
                true,
                Response::HTTP_BAD_REQUEST,
                [
