...
class WorkPackageCategoryControllerTest extends BaseController
{
    ...
    public function testCreateAction()
    {
        ...
        $form = $crawler->filter('#create-form')->first()->form();
        $form['create[name]'] = 'wp-category';

        $this->client->submit($form);
        $this->assertTrue($this->client->getResponse()->isRedirect());

        $this->client->followRedirect();
        $this->assertContains('WorkPackageCategory successfully created!', $this->client->getResponse()->getContent());
    ...
    public function testDeleteAction()
    {
        ...
        $this->client->followRedirect();
        $this->assertContains('WorkPackageCategory successfully deleted!', $this->client->getResponse()->getContent());
    }
    ...
    public function testEditAction()
    {
        ...
        $this->client->followRedirect();
        $this->assertContains('WorkPackageCategory successfully edited!', $this->client->getResponse()->getContent());
