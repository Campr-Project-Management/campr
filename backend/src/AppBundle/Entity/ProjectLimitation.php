 ...
 * ProjectLimitation.
 *
 * @ORM\Table(name="project_limitation")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ProjectLimitationRepository")
 */
class ProjectLimitation implements ProjectAwareInterface, ResourceInterface, CloneableInterface
{
    /**
     * @var int
     *
     ...
     * @Serializer\Exclude()
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Contract", inversedBy="projectLimitations")
     ...
     * @Serializer\Exclude()
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Project", inversedBy="projectLimitations")
