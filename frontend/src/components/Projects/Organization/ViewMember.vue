            ...
            <div class="col-md-6">
                ...
                <div class="header">
                    <div>
                        ...
                        <h1>John Doe <br/><span class="small"><b class="second-color">@john.d</b></span></h1>
                    </div>
                </div>
                <!-- /// End Header /// -->
                ...
                <div class="row flex flex-v-center">
                    <div class="col-md-6">
                        <!-- /// Member Avatar /// -->
                        <div class="avatar">
                            <img src="http://dev.campr.biz/uploads/avatars/41.jpg" alt="John Doe">
                        </div>
                        <!-- /// End Member Avatar /// -->
                    </div>
                        ...
                        <div class="row member-details">
                            <div class="col-md-12">
                                <div class="member-info">
                                    <p>{{ translateText('message.role') }}: <b>Developer</b></p>
                                    <p>{{ translateText('message.company') }}: <b>Trisoft</b></p>
                                    <p>{{ translateText('message.department') }}: <b>Development</b></p>
                                    <p>{{ translateText('message.subteam') }}: <b>Devs 1 Team</b></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="member-contact">
                            <div class="social-contanct">
                                ...
                                Facebook: <a href="https://www.facebook.com/TriSoftGroup/">https://www.facebook.com/TriSoftGroup/</a>
                            </div>
                            <div class="social-contanct">
                                <svg version="1.1" :width="size" :height="size" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16.4">
                                ...
                                Twitter: <a href="https://twitter.com/elonmusk">https://twitter.com/elonmusk</a>
                            </div>
                            <div class="social-contanct">
                                <svg version="1.1" :width="size" :height="size" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16.4">
                                ...
                                Linkedin: <a href="https://www.linkedin.com/company/trisoft-group">https://www.linkedin.com/company/trisoft-group</a>
                            </div>
                            <div class="social-contanct">
                                <svg version="1.1" :width="size" :height="size" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16.4">
                                    <g>
                                ...
                                Google Plus: <a href="https://plus.google.com/+TrisoftRo?hl=ro">https://plus.google.com/+TrisoftRo?hl=ro</a>
                            </div>
                            <div class="social-contanct">
                                <svg version="1.1" :width="size" :height="size" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16.4">
                                ...
                                Email: <a href="mailto:john.doe@campr.ro">john.doe@campr.ro</a>
                            </div>
                            <div class="social-contanct">
                                ...
                                Phone: <a href="tel:+40756095992">(+4) 0756 095 992</a>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...mapActions(['getProjectById', 'getProjectRoles', 'getProjectDepartments', 'getSubteams']),
