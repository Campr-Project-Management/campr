            ...
            <div class="col-md-6">
                ...
                <div class="header">
                    <div>
                        ...
                        <h1>{{member.firstName}} {{member.lastName}}<br/><span class="small"><b class="second-color">{{ member.email }}</b></span></h1>
                    </div>
                </div>
                <!-- /// End Header /// -->
                ...
                <div class="row flex flex-v-center">
                    <div class="col-md-6">
                        <!-- /// Member Avatar /// -->
                        <div class="avatar">
                            <img :src="member.gravatar" :alt="member.firstName + ' ' + member.lastName">
                        </div>
                        <!-- /// End Member Avatar /// -->
                    </div>
                        ...
                        <div class="row member-details">
                            <div class="col-md-12">
                                <div class="member-info">
                                    <p>{{ translateText('message.role') }}: <b>{{ memberRole }}</b></p>
                                    <p>{{ translateText('message.company') }}: <b>{{ memberCompany }}</b></p>
                                    <p>{{ translateText('message.department') }}: <b>{{ memberDepartment }}</b></p>
                                    <p>{{ translateText('message.subteam') }}: <b>{{ memberSubteam }}</b></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="flex flex-v-center">
                            <switches v-model="resource" :selected="true" :disabled="true"></switches>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="flex flex-v-center">
                            <switches v-model="raci" :selected="true" :disabled="true"></switches>
                        </div>
                        <hr class="nomarginbottom">
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="flex flex-v-center">
                            <switches v-model="org" :selected="false" :disabled="true"></switches>
                        </div>
                        <hr class="nomarginbottom">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4" v-for="dl in project.distributionLists">
                        <h4>{{ dl.name }}</h4>
                        <div class="flex flex-v-center">
                            <switches v-model="distribution[dl.id]" :selected="true" :disabled="true"></switches>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="member-contact">
                            <div class="social-contanct">
                                ...
                                {{ translateText('label.facebook') }}: <a :href="member.facebook">{{member.facebook}}</a>
                            </div>
                            <div class="social-contanct">
                                <svg version="1.1" :width="size" :height="size" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16.4">
                                ...
                                {{ translateText('label.twitter') }}: <a :href="member.twitter">{{ member.twitter }}</a>
                            </div>
                            <div class="social-contanct">
                                <svg version="1.1" :width="size" :height="size" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16.4">
                                ...
                                {{ translateText('label.linked_in') }}: <a :href="member.linkedIn">{{ member.linkedIn }}</a>
                            </div>
                            <div class="social-contanct">
                                <svg version="1.1" :width="size" :height="size" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16.4">
                                    <g>
                                ...
                                {{ translateText('label.gplus') }}: <a :href="member.gplus">{{ member.gplus }}</a>
                            </div>
                            <div class="social-contanct">
                                <svg version="1.1" :width="size" :height="size" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16.4">
                            ...
                            <div class="social-contanct">
                                ...
                                {{ translateText('label.phone') }}: <a :href="member.phone">{{ member.phone }}</a>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...mapActions(['getProjectById', 'getProjectRoles', 'getProjectDepartments', 'getSubteams', 'getMemberInfo']),
    ...
    computed: {
        ...
        memberCompany: function() {
            if (this.member.projectUsers !== undefined && this.member.projectUsers.length >= 1) {
                return this.member.projectUsers[0].company;
            }
            return '';
        },
        memberRole: function() {
            if (this.member.projectUsers !== undefined && this.member.projectUsers.length >= 1) {
                return this.member.projectUsers[0].projectRoleNames[0];
            }
            return '';
        },
        memberDepartment: function() {
            if (this.member.projectUsers !== undefined && this.member.projectUsers.length >= 1) {
                return this.member.projectUsers[0].projectDepartmentNames[0];
            }
            return '';
        },
        memberSubteam: function() {
            if (this.member.projectUsers !== undefined && this.member.projectUsers.length >= 1) {
                return this.member.projectUsers[0].projectTeamName;
            }
            return '';
        },
    },
