<template>
  <a href="" :title="active === false ? 'Add to Favourites' : 'Remove from Favourites'">
    <svg class="icon star" v-bind:class="{ active: active === true }" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
