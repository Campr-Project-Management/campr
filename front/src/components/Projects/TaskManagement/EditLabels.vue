<template>
    <div class="edit-labels page-section">
        <div class="header">
            <h1>Edit Task Labels</h1>
            <div class="flex flex-v-center">
                <router-link :to="{name: 'project-task-management-list'}" href="javascript:void(0)" class="btn-rounded btn-auto">View Grid</router-link>
        ...
        <div class="label-list">
            <div class="flex flex-space-between label-row">
                <div class="flex">
                    <div class="label-icon yellow">Bug</div>
                    <div class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas pretium imperdiet hendrerit. Vivamus varius iaculis odio, ac tincidunt neque mattis at.</div>
                    <div class="tasks">3 Open Tasks</div>
                </div>
                <div class="actions">
            ...
            <div class="flex flex-space-between label-row">
                <div class="flex">
                    <div class="label-icon ocean">Design</div>
                    <div class="description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas pretium imperdiet hendrerit. Vivamus varius iaculis odio, ac tincidunt neque mattis at.</div>
                    <div class="tasks">3 Open Tasks</div>
                </div>
                <div class="actions">
        ...
        <router-link :to="{name: 'project-task-management-add-label'}" class="btn-rounded second-bg btn-auto">New Label</router-link>
    </div>
</template>
